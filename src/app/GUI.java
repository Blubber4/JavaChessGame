...
public class GUI extends JPanel {
	...
	public void setTurnText(String a){		
		CHNC.setText(a);
		CHNC.setFont(new Font("Verdana",1,20));
	...
	public void chessGameGUI() {
		...
		if ( newboard.blackTurn == true ){
			move = "black turn";
		}
		else{
			move = "white turn";
			//CHNC.setText(move);
			//showPlayerPanel.add(CHNC);
			//topMenuPanel.add(CHNC);
		} */

		CHNC = new JLabel(move);
		showPlayerPanel.add(CHNC);
		showPlayerPanel.setBorder(new LineBorder(Color.BLACK));
